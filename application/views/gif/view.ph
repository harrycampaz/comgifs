        ...
        <div class="thumbnail">          
           ...
           <a href="https://twitter.com/share" class="twitter-share-button" data-url="<?= base_url() ?>gifs/view/<?= $datos['imagen']."/".$p ?>/" data-lang="es" data-related="@Frases_App">Twittear</a>
            <script>!function(d, s, id) {
                ...
                <div class="fb-like"  data-href="https://www.comgifs.com/gifs/view/<?= $datos['imagen'] ?>" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
