    ...
    <div class="col-lg-8">
        ...
        <div class="thumbnail">          
            ...
            <h5> <strong class ="text-info">|<span class="glyphicon glyphicon-eye-open"></span><?php echo' : ' . $datos['vista'] ?> | </strong>
                <?= anchor('gifs/gifs_categoria/' . $datos['id_categoria'], $datos['nombre_categoria']) ?></h5>
            ...
            <?php if ($end != 1) { ?>
                ...
                <div class="separator" style="clear: both; text-align: center;">
                    ...
                    <p>Si no puede ver el VIDEO prueba con otro navegador o abre el 
                   <?= anchor('gifs/view/' . $datos['imagen'] . '/gifs/muygifs',"GIF original"); ?></a></p>
                   <?php if (!(isset($myname))) { ?>
<!--                         <div style="text-align:center">
			...
			<?php } ?>
                    <video id="video" autoplay loop autobuffer controls="controls" width="480" height="500" muted >
                        <source src="<?= $datos['video'] ?>">
                    ...
                    <?php } else { ?>
                        ...
                        <div class="separator" style="clear: both; text-align: center;">
                             ...
                             <p>Si no ves el VIDEO prueba con otro navegador o abre el 
                   <?= anchor('gifs/view/' . $datos['imagen'] . '/gifs/muygifs',"GIF original"); ?></a></p>
                            <video id="video" autoplay autobuffer controls="controls" loop width="280" height="300" muted >
                                <source src="<?= $datos['video'] ?>">
...
<!--                            <div style="text-align:center">
				<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
				 ComGIFSAdaptables_contenido 
				<ins class="adsbygoogle"
				     style="display:block"
				     data-ad-client="ca-pub-4780835939148340"
				     data-ad-slot="1470924392"
				     data-ad-format="auto"></ins>
				<script>
				(adsbygoogle = window.adsbygoogle || []).push({});
				</script>
                    ...
                    if (!empty($datos['etiquetas'])) {
                        ...
                        for ($i = 0; $i < count($etiquetas); $i++) {
                            ...
                            if ($etiquetas[$i] != "") {
                                echo anchor('gifs/gifs_etiquetas/' . $etiquetas[$i], $etiquetas[$i], '');
                                echo ", ";
                            }
                        }
                    }
                    ...
                    <?php
                    $attributes = array('id' => 'ver_nuevos', 'class' => 'form');
                    echo form_open('gifs/subir_gif', $attributes);
                    ?>
