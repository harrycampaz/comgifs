...
<nav class="col-lg-4">
 ...
 <div class="well"  style="padding: 8px;">
        <ul class="nav nav-list">        
          <li class="nav-header">Moderador</li>
          <hr/>
         <li class=""><?php echo anchor('all_gifs','Gifs', array('title'=>'Todos los gifs'))?></li>
        <li class=""><?php echo anchor('user','Users', array('title'=>'Users'))?></li>
